...
from models.meta_learners import fit_xlearner
from evaluation.evaluate_models import evaluate

ROOT = "data"
RESULTS_DIR = "results/xlearner"
...
for path, dirs, files in os.walk(ROOT):
    ...
    for file in files:
        ...
        model, cate_pred = fit_xlearner(X, W, Y)
...
if len(results_all) > 0:
    ...
    output_path = os.path.join(RESULTS_DIR, "xlearner_results.csv")
