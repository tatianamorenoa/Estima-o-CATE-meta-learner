...
from models.meta_learners import fit_drlearner
from evaluation.evaluate_models import evaluate

ROOT = "data"
RESULTS_DIR = "results/drlearner"
...
for path, dirs, files in os.walk(ROOT):
    ...
    for file in files:
        ...
        model, cate_pred = fit_drlearner(X, W, Y)
