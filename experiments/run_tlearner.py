...
from models.meta_learners import fit_tlearner
from evaluation.evaluate_models import evaluate

ROOT = "data"
RESULTS_DIR = "results/tlearner"
...
for path, dirs, files in os.walk(ROOT):
    ...
    for file in files:
        ...
        model, cate_pred = fit_tlearner(X, W, Y)
...
if len(results_all) > 0:
    ...
    output_path = os.path.join(RESULTS_DIR, "tlearner_results.csv")
